...
class UI_EditAssetType(bpy.types.Operator):
	...
	asset_label_category : bpy.props.PointerProperty(name="Asset Label Category", type=CustoLabelCategoryEnumProperties)
	mesh_slot_label_category : bpy.props.PointerProperty(name="Mesh Slot Label Category", type=CustoLabelCategoryEnumProperties)
	...
	material_slot_label_category : bpy.props.PointerProperty(name="Material Slot Label Category", type=CustoLabelCategoryEnumProperties)
	material_label_category : bpy.props.PointerProperty(name="Material Label Category", type=CustoLabelCategoryEnumProperties)
	material_variation_label_categories_count : bpy.props.IntProperty(name="Material Variation Label Category Count", default=1, min=1)
	...
	def draw(self, context):
		...
		col.prop(self.asset_label_category, 'name', text='Asset ID')
		col.prop(self.mesh_slot_label_category, 'name', text='Mesh Slot')
		...
		col.prop(self.material_slot_label_category, 'name', text='Material Slot')
		col.prop(self.material_label_category, 'name', text='Material')
		draw_label_categories(col, 'Material Variation:', self, 'material_variation_label_categories_count', 'material_variation_label_categories', context.scene.custo_handler_settings, 'custo_label_categories')
	...
	def invoke(self, context, event):
		...
		self.current_asset_type.asset_label_category.name = self.current_asset_type.asset_label_category.name

		self.mesh_slot_label_category.name = self.current_asset_type.mesh_slot_label_category.name
		...
		self.material_slot_label_category.name = self.current_asset_type.material_slot_label_category.name
	...
	def execute(self, context):
		...
		self.current_asset_type.asset_label_category.clear()

		self.current_asset_type.asset_label_category.name = self.asset_label_category.name
		
		self.current_asset_type.mesh_slot_label_category.name = self.mesh_slot_label_category.name
		...
		self.current_asset_type.material_slot_label_category.name = self.material_material_slot_label_categorylabel_category.name
...
class UI_AddAssetType(bpy.types.Operator):
	...
	def execute(self, context):
		...
		s.asset_label_category.name = self.asset_label_category.name
			
		s.mesh_slot_label_category.name = self.mesh_slot_label_category.name
		
		for l in self.mesh_variation_label_categories.label_category_enums:
			asset_label = s.mesh_variation_label_categories.add()
			asset_label.name = l.name

		s.material_slot_label_category.name = self.material_slot_label_category.name
